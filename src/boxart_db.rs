...
pub fn get_boxart_db(system: &str) -> Option<&'static str> {
    match system.to_uppercase().as_str() {
        ...
        "ATARIST" => Some(include_boxart_db!("ATARIST")),
        ...
        "CPS1" => Some(include_boxart_db!("FBNEO")),
        "CPS2" => Some(include_boxart_db!("FBNEO")),
        "CPS3" => Some(include_boxart_db!("FBNEO")),
        ...
        "SATURN" => Some(include_boxart_db!("SATURN")),
